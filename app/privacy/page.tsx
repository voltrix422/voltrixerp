      ...
      <section className="pt-36 pb-24 px-4">
        <div className="max-w-3xl mx-auto space-y-12">
          ...
          <div className="prose prose-neutral max-w-none space-y-6">
            ...
            <p className="text-neutral-600">If you have any questions about this Privacy Policy, please contact us at <a href="mailto:ops@voltrixbatteries.com" className="text-[#1a9f9a] hover:underline">ops@voltrixbatteries.com</a></p>
          </div>
        </div>
      </section>
      <Footer />

...
ALTER TABLE "erp_users" ADD COLUMN "branch_id" TEXT;
CREATE INDEX "erp_users_branch_id_idx" ON "erp_users"("branch_id");

ALTER TABLE "erp_pos_terminals" ADD COLUMN "branch_id" TEXT;
CREATE INDEX "erp_pos_terminals_branch_id_idx" ON "erp_pos_terminals"("branch_id");

ALTER TABLE "erp_pos_sales" ADD COLUMN "branch_id" TEXT;
